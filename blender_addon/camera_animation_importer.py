bl_info = {
    "name": "WebXR Camera Animation Importer",
    "author": "James C. Kane",
    "version": (1, 0, 0),
    "blender": (4, 2, 0),
    "location": "File > Import > WebXR Camera Animation (.json)",
    "description": "Import WebXR camera animations as keyframed cameras for editing and GLTF export",
